      ...
      <table class="table table-responsive table-striped table-bordered bootstrap-datatable datatable">
        <thead>
          <tr>
            ...
            <th>Delivery man area</th>
            <th>Delivery man image</th>
            <th>Status</th>
            <th>Actions</th>
          </tr>
        </thead>
        ...
        <tr>
          ...
          <td class="center">
            <form action="/edit_dm_pub_stat" method="POST" style="display: inline-block; padding: 0px; margin: 0px;">
              {{ csrf_field() }}
            ...
            <a class="btn btn-info" href='/edit_dm/{{ $product->p_id}}'>
              <i class="halflings-icon white edit"></i>
            </a>
            <!-- **************** -->
            <a class="btn btn-danger" href='/delete_dm/{{ $product->p_id }}' id="delete"><i class="halflings-icon white trash"></i></a>
          </td>
        </tr>
        @endforeach
        </tbody>
